<%-- 
    Document   : EditarObra
    Created on : Jun 24, 2020, 12:53:38 AM
    Author     : trece
--%>
...
<%
        ...
        int indiceEditarObra = Integer.parseInt(request.getParameter("indiceEditarObra"));

        Obra obraEdit = ((ArrayList<Obra>) session.getAttribute("listaTodosObras")).get(indiceEditarObra);
        session.setAttribute("actualizarObra", obraEdit);
                ...
                <fieldset>
                    ...
                    <div class="row">     
                        ...
                        <label class="col-4 col-sm-4">
                            ...
                            <input class="form-check-input" type="radio" checked="" id="idRadioTrabajador" name="radioTrabajador"/>

                            <%=(obraEdit.getTrabObra().getPerTrabajador().getNombre_Persona()) + " " + (obraEdit.getTrabObra().getPerTrabajador().getNombre_Persona())%>
                        </label>
            ...
            <div class="divExistCliente" id="idExistCliente">
                <fieldset>
                    ...
                    <div class="divClientAlreadyExists" id="idClientAlreadyExists">
                        ...
                        <div class="row">
                            <input type="hidden" class="form-control  mx-auto col-12"  disabled="" value="" name="idClientObra" id="idClientObr">
                            <div class="col-3">
                                <div class="form-group">
                                    <label for="nameClientObra" class="col-8">Nombre del Cliente
                                        <input type="text" class="form-control  mx-auto col-12" value="<%=(obraEdit.getClienteObra().getPersonaCliente().getNombre_Persona()) %>"  disabled="" name="Si" id="nameClientObra">
                                    </label>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group mx-auto">
                                    <label for="lastNameClienteObra" class="col-12">Apellidos Cliente
                                        <input type="text" class="form-control col-12" disabled="" value="<%=(obraEdit.getClienteObra().getPersonaCliente().getPaterno_Persona() + " " + obraEdit.getClienteObra().getPersonaCliente().getMaterno_Persona() ) %>"  name="" id="lastNameClienteObra">
                                    </label>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group mx-auto">
                                    <label for="lastNameClienteObra" class="col-12">Pais y Estado
                                        <input type="text" class="form-control col-12" disabled="" value="<%= (obraEdit.getClienteObra().getPersonaCliente().getDireccionPersona().getPais_Direccion()+ " " + obraEdit.getClienteObra().getPersonaCliente().getDireccionPersona().getEstado_Direccion() )%>" name="CpuntryClientObra" id="PaisClienObra">
                                    </label>
                                </div>
                            </div>
                            <div class="col-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control textBox" value="<%= (obraEdit.getFechaInicio_Obra())%>" placeholder="" name="DateStartObra" id="fechaInicio"/>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                <label for="dateEnd" class="">Fecha Fin de Obra</label>
                                <input type="date" class="form-control textBox" value="<%= (obraEdit.getFechaFin_Obra())%>" placeholder="" name="DateEndObra" id="dateEnd"/>
                            </div>
                        </div>    
                        <div class="col-4">
                            <div class="form-group">
                                <label for="dateCot">Fecha Cotizacion de Obra</label>
                                <input type="date" class="form-control textBox" value="<%= (obraEdit.getFechaCotizacionObra())%>" placeholder="" name="DateCotObra" id="dateCot"/>
                            </div>
                        </div>  
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="form-group mx-auto">
                                ...
                                <input type="text" class="form-control textBox col-6" value="<%= ( obraEdit.getTotal_Obra() )%>" placeholder="" name="AnticipObra" id="anticipObra" onkeypress="return filterFloat(event,this);" />
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group mx-auto">
                        ...
                        <div class="col-3">
                            <div class="form-group mx-auto">
                                <label for="" class="col-6"></label>
                                <button type="button" class="form-control col-6 btn btn-warning s" id="prevFinish">Regresare</button>
...
<link href="./Estilos/cssEditarObra.css" rel="stylesheet" type="text/css"/>
